...
const AgentControlCenter = () => {
  ...
  const getColor = (type: string, agent: string) => {
    ...
    if (type === 'system') return 'text-slate-400';
    
    // Agent colors
    if (agent === 'MonitorAgent') return 'text-cyan-400';
    if (agent === 'DecisionAgent') return 'text-purple-400';
    if (agent === 'NotificationAgent') return 'text-amber-400';
    if (agent === 'MarketAgent') return 'text-fuchsia-400';
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-slate-500 mt-1 text-sm tracking-widest">Autonomous Fleet Intelligence</p>
          </div>
          
          <div className="flex gap-4 text-xs">
            <div className="px-4 py-2 rounded-md bg-white/5 border border-white/10 backdrop-blur-md">
              <span className="text-slate-500">SYSTEM STATUS</span>
              <div className="text-emerald-400 font-semibold flex items-center gap-2 mt-1">
            ...
            <div className="px-4 py-2 rounded-md bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <div className="text-cyan-400 font-semibold mt-1">1,024</div>
            </div>
          </div>
        </motion.header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[75vh]">
          ...
          <motion.div 
            ...
            className="lg:col-span-2 relative rounded-xl bg-black/40 border border-cyan-500/20 shadow-[0_0_30px_rgba(6,182,212,0.05)] overflow-hidden flex flex-col"
          >
            {/* Terminal Header */}
            <div className="h-10 border-b border-cyan-500/20 bg-cyan-950/10 flex items-center px-4 justify-between backdrop-blur-md">
          ...
          >
            ...
            <div className="rounded-xl bg-white/[0.02] border border-white/5 p-5 space-y-4">
              <h3 className="text-xs text-slate-500 tracking-widest uppercase font-sans">Network Health</h3>
            ...
            {/* Active Protocols */}
            <div className="rounded-xl bg-white/[0.02] border border-white/5 p-5 flex-1 flex flex-col font-sans">
              <h3 className="text-xs text-slate-500 tracking-widest uppercase mb-4">Active Protocols</h3>
